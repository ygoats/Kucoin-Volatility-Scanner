...
symbol_list = ['BTC-USDT', 'ETH-USDT', 'BNB-USDT', 'ADA-USDT', 'XRP-USDT', 'DOGE-USDT', 'UNI-USDT', 'SOL-USDT']
symbol_listR = ['BTCUSDT', 'ETHUSDT', 'BNBUSDT', 'ADAUSDT', 'XRPUSDT', 'DOGEUSDT', 'UNIUSDT', 'SOLUSDT']
...
# =============================================================================
        ...
        if index == 0 and index2 == 0 and volMult > 1.21 and atrMult > 1.21:
